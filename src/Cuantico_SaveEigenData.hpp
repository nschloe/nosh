...
//
// @HEADER
#ifndef CUANTICO_SAVEEIGENDATA_H
#define CUANTICO_SAVEEIGENDATA_H
// =============================================================================
...
SaveEigenData ( Teuchos::ParameterList &eigenParamList,
                const Teuchos::RCP<const Cuantico::ModelEvaluator> &modelEval,
                const Teuchos::RCP<Cuantico::CsvWriter> &statsWriter
                );
...
const Teuchos::RCP<const Cuantico::CsvWriter> csvWriter_;
...
#endif // CUANTICO_SAVEEIGENDATA_H
