...
#ifndef GINLA_MODELEVALUATOR_BORDERED_H
#define GINLA_MODELEVALUATOR_BORDERED_H
...
private:
   ...
   const Teuchos::RCP<Ginla::ModelEvaluator::Default> modelEvaluatorDefault_;
...
#endif // GINLA_MODELEVALUATOR_BORDERED_H
