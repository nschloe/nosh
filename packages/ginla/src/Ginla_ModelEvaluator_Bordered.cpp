...
Bordered ( const Teuchos::RCP<Ginla::Operator::Virtual>      & glOperator,
         ...
         modelEvaluatorDefault_ ( Teuchos::rcp( new Ginla::ModelEvaluator::Default( glOperator, komplex, grid, params ) ) ),
         firstTime_ ( true ),
...
Bordered ( const Teuchos::RCP<Ginla::Operator::Virtual>      & glOperator,
         ...
         modelEvaluatorDefault_ ( Teuchos::rcp( new Ginla::ModelEvaluator::Default( glOperator, komplex, state, params ) ) ),
         firstTime_ ( true ),
         regularMap_ (  modelEvaluatorDefault_->getMap() ),
         extendedMap_ ( this->createExtendedMap_ ( *regularMap_ ) ),
         importFromExtendedMap_(  Epetra_Import(*regularMap_,*extendedMap_) ),
...
{ 
    ...
    Teuchos::RCP<Ginla::State> diag = modelEvaluatorDefault_->createState( newDiag );
