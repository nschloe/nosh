...
#ifndef GINLA_FDM_OPERATOR_BCINNER_H
#define GINLA_FDM_OPERATOR_BCINNER_H
...
public:
    ...
    virtual
    void
    getJacobianRow ( const Teuchos::RCP<const Ginla::State::Virtual> & state,
                    const int                                k,
...
private:
    double_complex
    getFEntry_ ( const Teuchos::RCP<const Ginla::State::Virtual> & state,
...
#endif // GINLA_FDM_OPERATOR_BCINNER_H
