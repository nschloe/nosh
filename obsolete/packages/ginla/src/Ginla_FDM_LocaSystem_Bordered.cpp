...
Ginla::FDM::LocaSystem::Bordered::getJacobian() const
{
    return jacobian_;
}
// =============================================================================
Teuchos::RCP<Epetra_CrsMatrix>
Ginla::FDM::LocaSystem::Bordered::getPreconditioner() const
{
...
void
Ginla::FDM::LocaSystem::Bordered::setParameters ( const LOCA::ParameterVector &p )
{ 
...
// =============================================================================
// function used by LOCA
void Ginla::FDM::LocaSystem::Bordered::
...
Ginla::FDM::LocaSystem::Bordered::getMap() const
{
    return extendedMap_;
}
// =============================================================================
